...
modc_0 <- coxph(Surv(tiempo, complicacion) ~ 1, ties = "breslow", data = datos)
modc_1 <- coxph(Surv(tiempo, complicacion) ~ edad, ties = "breslow", data = datos)
modc_2 <- coxph(Surv(tiempo, complicacion) ~ sexo, ties = "breslow", data = datos)
modc_3 <- coxph(Surv(tiempo, complicacion) ~ fumador, ties = "breslow", data = datos)
modc_4 <- coxph(Surv(tiempo, complicacion) ~ actividad, ties = "breslow", data = datos)
modc_5 <- coxph(Surv(tiempo, complicacion) ~ comorbilidades, data = datos, ties = "breslow")
modc_6 <- coxph(Surv(tiempo, complicacion) ~ edad + fumador, ties = "breslow", data = datos)
modc_7 <- coxph(Surv(tiempo, complicacion) ~ edad + fumador + sexo, ties = "breslow", data = datos)
modc_8 <- coxph(Surv(tiempo, complicacion) ~ edad + fumador + actividad, ties = "breslow", data = datos)
modc_9 <- coxph(Surv(tiempo, complicacion) ~ edad + fumador + comorbilidades, ties = "breslow", data = datos)
...
summary(mod_0)
mod_1 <- survfit(Surv(tiempo, complicacion) ~ edad, data = datos)
summary(mod_1)
mod_2 <- survfit(Surv(tiempo, complicacion) ~ sexo, data = datos)
summary(mod_2)
mod_3 <- survfit(Surv(tiempo, complicacion) ~ fumador, data = datos)
summary(mod_3)
mod_4 <- survfit(Surv(tiempo, complicacion) ~ actividad, data = datos)
summary(mod_4)
mod_5 <- survfit(Surv(tiempo, complicacion) ~ comorbilidades, data = datos)
summary(mod_5)
