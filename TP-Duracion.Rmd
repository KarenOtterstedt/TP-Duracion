...
## *Edad*
Para conocer el comportamiento de los datos recolectados, sobre la variable edad se realiza una categorización 
...
titulo1 <- str_wrap("Figura : Probabilidad de supervivencia estimada según edades de los pacientes", width = 40)
...
# Actividad:
titulo2 <- str_wrap("Figura : Probabilidad de supervivencia estimada según nivel de actividad física", width = 40)
...
titulo <- str_wrap("Figura : Probabilidad de supervivencia estimada según cantidad de comorbilidades", width = 40)
...
```{r pvalues-tests, include = F}
# # Lo mismo pero con p-values:
# pvalues <- as.data.frame(rbind(pchisq(-2*modc_1$loglik[2], 
#                                       df = 1, lower.tail = F),
#                                pchisq(-2*modc_2$loglik[2], df = 1,
#                                       lower.tail = F),
#                                pchisq(-2*modc_3$loglik[2], df = 1,
#                                       lower.tail = F),
#                                pchisq(-2*modc_4$loglik[2], df = 1,
#                                       lower.tail = F),
#                                pchisq(-2*modc_5$loglik[2], df = 1,
#                                       lower.tail = F)))
# 
# 
# 
...
# 
# row.names(pvalues) <- c( 'Edad', 'Sexo', 'Fumador', 'Actividad', 'Comorbilidades')
# 
# pvalues
