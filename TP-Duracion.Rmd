...
```{r Edades, echo = F, fig.cap = 'Histograma de las edades de los pacientes al iniciar su seguimiento',out.width='90%', cache = T}
...
```{r tab-actividad, echo = FALSE, fig.cap = 'Nivel de actividad física de los pacientes', cache = TRUE}
...
<!-- VER, no me convence -->
<!-- CATEGORIZAR -->
En la Tabla \@ref(tab:tablacomorbilidad) puede verse que mucha gente presentó 2, 3 o 4 comorbilidades, y, esos grupos de personas tuvieron tiempos medios registrados similares. Sólo 3 personas no tuvieron comorbilidades.
